...
Scoping signed off by Terra on 2026-09-03; T01c is committed; T02 v4 is sealed and ready for execution.
...
- T02: local IPC, privacy boundary, and Claude-specific specification (S6-S7).
  Reviewed; depends on T01c and runs only after its v4 contract, convention
